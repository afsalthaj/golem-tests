...
impl Guest for Component {
    ...
    fn add_item_failed(_item: ProductItem,) -> Option<u32> {
        None
    }
    ...
    fn remove_item_fail(_product_id: String) -> Result<String, String> {
        Err("I am sorry. I will not remove your product".to_string())
    }
    ...
    fn get_cart_contents_failed() -> Result<Vec<ProductItem>, String> {
        Err("I am sorry. I will not give you your cart contents".to_string())
    }
